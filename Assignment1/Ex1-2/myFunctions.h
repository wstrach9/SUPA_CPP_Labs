...
void createcopy(std::string, std::string&);
void checkfileexists(std::string, std::string&);
std::string printtf(std::string);
void printn(std::vector<std::string>, std::string, std::string);
...
void printmags(std::vector<float>, std::string);
...
void printfit(float,float,float, std::string);
...
void printxtothey(std::vector<float>, std::string);