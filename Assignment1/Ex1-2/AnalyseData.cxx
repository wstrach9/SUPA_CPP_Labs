// compile with:
// g++ -std=c++20 -w /workspaces/SUPA_CPP_Labs/Assignment1/Ex1-2/AnalyseData.cxx /workspaces/SUPA_CPP_Labs/Assignment1/Ex1-2/myFunctions.cxx -o AnalyseData
...
int main(){
	...
	*/
	...
	printn(datastr, file);	//prints first n (user input) lines to terminal
	...
	*/
	...
	printmags(magnitudes); //prints first n or all (user input) magnitudes to terminal
